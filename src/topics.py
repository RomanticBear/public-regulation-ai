...
BENCHMARK_CHECKLIST: dict[str, dict] = {
    ...
    "사규심의위원회": {
        ...
        # 오탐 방지: 앵커 없이는 「있음」 불가, 유사 조문만 있으면 「약함」
        "match_mode": "strict",
    },
    "직권 개정": {
    ...
    "사규 공개": {
        ...
        # 「공포」 조문명 + 공개 의무 (한국가스공사 제19조 등)
        "anchor_groups": [["공개하여야"], ["홈페이지", "게시", "ALIO", "정보통신망"]],
    },
    "비공개 사유": {
    ...
    "부분공개 규정": {
        ...
        "keywords": ["부분공개", "일부공개", "부분 공개", "제외하고 공개"],
        "anchor_keywords": [
            "부분공개",
            "일부공개",
            "부분 공개",
        ...
        # 「분리·제외하고 공개」 형태 (한국수자원공사 제14조③ 등)
        "anchor_groups": [
            ["제외하고 공개", "분리할 수 있는", "분리하여 공개"],
            ["혼합", "공개"],
        ],
    },
    "별지·서식 체계": {
